...
namespace AppLovinMax.Scripts.IntegrationManager.Editor
{
    public class AppLovinIntegrationManagerWindow : EditorWindow
    {
        ...
        private void Awake()
        {
            ...
            uninstallIcon = new Texture2D(1, 1, TextureFormat.RGBA32, false); // 1. Initial size doesn't matter here, will be automatically resized once the image asset is loaded. 2. Set mipChain to false, else the texture has a weird blurry effect.
